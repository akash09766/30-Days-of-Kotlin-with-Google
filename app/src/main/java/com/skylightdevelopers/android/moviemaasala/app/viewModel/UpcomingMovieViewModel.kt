...
class UpcomingMovieViewModel @Inject constructor(
    ...
    val TAG = "UpcomingMovieViewModel"
    ...
    fun getUpcomingMoviesWithoutCache(apiKey: String, langCode: String, pageNum: Int) {
        ...
        job = CoroutineScope(Dispatchers.Main).launch {
            moviesRepository.getUpcomingMovies(apiKey, langCode, pageNum)
                .collect { data ->
